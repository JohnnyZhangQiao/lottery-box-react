...
const BoxList = props => {
    ...
    return (<div>
      {list.length > 0 ? (<ul className={style['box-list']}>
          {list.map((item, key) => {
                return (<li key={key} className={style['box-item']} onClick={() => {
                ...
                <div className={style['box-author']}>
                  <img src={item.authorPic} alt={item.authorName} className={style['author-pic']}/>
...
//# sourceMappingURL=BoxList.jsx.map