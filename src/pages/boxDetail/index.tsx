...
import { TBoxDetail } from '@/types/index/box';
...
const BoxDetail: FC = () => {
  ...
  const [info, setInfo] = useState<TBoxDetail>({
    id: 0,
    boxImg: '',
    title: '',
    authorPic: '',
  ...
  function getBoxDetail(bId?: string) {
          ...
          <section>
            ...
            <ul>
              ...
              <li className={style['info-item']}>
                ...
                <span
                  className={style['info-tip']}
                >{`${info.onSale}/${info.sellLimit}`}</span>
              </li>
              <li className={style['info-item']}>
